...
import (
	...
	"sigs.k8s.io/descheduler/pkg/framework/plugins/removepodsviolatingtopologydomain"
...
func RegisterDefaultPlugins(registry pluginregistry.Registry) {
	...
	pluginregistry.Register(removepodsviolatingtopologydomain.PluginName, removepodsviolatingtopologydomain.New, &removepodsviolatingtopologydomain.RemovePodsViolatingTopologyDomain{}, &removepodsviolatingtopologydomain.RemovePodsViolatingTopologyDomainArgs{}, removepodsviolatingtopologydomain.ValidateRemovePodsViolatingTopologyDomainArgs, removepodsviolatingtopologydomain.SetDefaults_RemovePodsViolatingTopologyDomainArgs, registry)
}
